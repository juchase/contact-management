...
import { alertConfirm, contactDetail } from "../../lib/api/ContactApi";
import { alertError, alertSuccess } from "../../lib/alert";
import { useEffectOnce, useLocalStorage } from "react-use";
import { addressDelete, addressList } from "../../lib/api/addressApi";
import { userDetail } from "../../lib/api/UserApi";
import CardListAddressLayout from "../CardListAddressLayout";
...
export default function ContactDetail() {
  ...
  async function handleDeleteAddress(addressId) {
    if (!(await alertConfirm("Are you sure wan't to delete this address?"))) {
      return;
    }
    ...
    if (response.status === 200) {
      await alertSuccess("Adress deleted successfully");
  ...
  useEffectOnce(() => {
    ...
    fetchAddresses().then(() => console.log("Address fetched successfully"));
  });
            ...
            <div className="mb-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                {addresses.map((address) => (
                  <CardListAddressLayout key={address.id}>
